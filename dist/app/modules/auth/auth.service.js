...
const resetPassword = (payload, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // payload.newPassword (newPassword ta postman e likhte hobe , ekhane jeta dibo seta postman e likhte hobe)
    payload.newPassword, Number(env_1.envVars.BCRYPT_SALT_ROUND));
